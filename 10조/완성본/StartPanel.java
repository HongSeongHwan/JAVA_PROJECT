...
public class StartPanel extends JPanel{
	...
	private JPanel		titlePanel, mainPanel, bottomPanel;		//	세부 패널
	private JLabel		lblTitle, lblPhoto, lblQuestion , lblCopyright;	// 제목, 사진, 질문, 저작권
	private ImageIcon	iconPhoto, iconQuestion;				// 이미지 삽입용
